"""XRobot SDK integration utilities.

Provides real-time body tracking streaming (XRobotStreamer) and recorded
data playback (XRobotRecorder) for XRobot VR tracking systems.
Requires the xrobotoolkit_sdk package to be installed separately.
"""
