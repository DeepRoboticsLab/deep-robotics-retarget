"""Rotation utility functions for quaternion and Euler angle operations.

Provides numpy and PyTorch implementations of quaternion multiplication,
rotation, inverse rotation, and conversions between quaternion and Euler
angle representations. Supports both scalar-first (wxyz) and scalar-last
(xyzw) quaternion conventions.
"""
