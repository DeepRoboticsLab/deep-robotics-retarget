"""SMPL/SMPLX body model loading and processing utilities.

Provides functions to load SMPL/SMPLX motion data, run forward kinematics
through the body model, and extract per-frame joint positions/orientations
for retargeting.
"""
