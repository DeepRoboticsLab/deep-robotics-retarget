"""Visualize robot URDF in Isaac Gym simulator.

Loads a robot URDF and displays it in Isaac Gym for visual inspection.
Requires Isaac Gym to be installed. Configure asset_file to your robot.
...
asset_root = f"../assets/"
asset_file = "DR02/DR02_pro.urdf"  # Configure this to your robot URDF
