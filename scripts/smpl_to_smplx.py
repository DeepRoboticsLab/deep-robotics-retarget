"""Convert SMPL motion data to SMPL-X format.

Handles beta padding (10 to 16), pose truncation, and field renaming
for compatibility with SMPL-X body models.

Usage:
    python scripts/smpl_to_smplx.py --src_folder /path/to/smpl --tgt_folder /path/to/smplx
"""
