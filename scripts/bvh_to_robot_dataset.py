"""Batch retarget BVH motion dataset to robot joint configurations.

Processes a folder of BVH files, retargets each to robot joint configurations,
    ...
    for dirpath, _, filenames in os.walk(src_folder):
        for filename in filenames:
            if filename.endswith(".bvh"):
                bvh_file_paths.append(os.path.join(dirpath, filename))
